 ...
 */
public class ShowCaipiraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("  Caipiras");
        ...
        voltar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(idList>0) {
                    idList = idList - 1;
                    piadas = Caipiras.getPCaipiras().get(idList);
                    tvTitulo.setText(piadas.getTitulo());
                    tvPiada.setText(piadas.getPiada());
                    Toast.makeText(ShowCaipiraActivity.this, (idList+1)+" de " + (szList), Toast.LENGTH_SHORT).show();
                } else{
                    Toast.makeText(ShowCaipiraActivity.this, 1 +" de " + (szList), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        avancar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(idList<(szList-1)) {
                    ...
                    Toast.makeText(ShowCaipiraActivity.this, (szList) +" de " + (szList), Toast.LENGTH_SHORT).show();
                }
            }
        });
