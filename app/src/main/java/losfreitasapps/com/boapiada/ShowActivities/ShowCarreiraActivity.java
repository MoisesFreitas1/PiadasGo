 ...
 */
public class ShowCarreiraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("  Profissões");
        ...
        voltar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(idList>0) {
                    idList = idList - 1;
                    piadas = Carreira.getPCarreira().get(idList);
                    tvTitulo.setText(piadas.getTitulo());
                    tvPiada.setText(piadas.getPiada());
                    Toast.makeText(ShowCarreiraActivity.this, (idList+1)+" de " + (szList), Toast.LENGTH_SHORT).show();
                } else{
                    Toast.makeText(ShowCarreiraActivity.this, 1 +" de " + (szList), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        avancar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(idList<(szList-1)) {
                    ...
                    Toast.makeText(ShowCarreiraActivity.this, (szList) +" de " + (szList), Toast.LENGTH_SHORT).show();
                }
            }
        });
