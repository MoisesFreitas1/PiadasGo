 ...
 */
public class ShowJoaozinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("  Joãozinho");
        ...
        voltar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(idList>0) {
                    idList = idList - 1;
                    piadas = Joaozinho.getPJoaozin().get(idList);
                    tvTitulo.setText(piadas.getTitulo());
                    tvPiada.setText(piadas.getPiada());
                    Toast.makeText(ShowJoaozinActivity.this, (idList+1)+" de " + (szList), Toast.LENGTH_SHORT).show();
                } else{
                    Toast.makeText(ShowJoaozinActivity.this, 1 +" de " + (szList), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        avancar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(idList<(szList-1)) {
                    ...
                    Toast.makeText(ShowJoaozinActivity.this, (szList) +" de " + (szList), Toast.LENGTH_SHORT).show();
                }
            }
        });
