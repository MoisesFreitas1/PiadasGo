 ...
 */
public class ShowCurtasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voltar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(idList>0) {
                    idList = idList - 1;
                    piadas = Curtas.getPCurtas().get(idList);
                    tvTitulo.setText(piadas.getTitulo());
                    tvPiada.setText(piadas.getPiada());
                    Toast.makeText(ShowCurtasActivity.this, (idList+1)+" de " + (szList), Toast.LENGTH_SHORT).show();
                } else{
                    Toast.makeText(ShowCurtasActivity.this, 1 +" de " + (szList), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        avancar.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v) {
                if(idList<(szList-1)) {
                    ...
                    Toast.makeText(ShowCurtasActivity.this, (szList) +" de " + (szList), Toast.LENGTH_SHORT).show();
                }
            }
        });
